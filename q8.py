...
with open('q8.mp3', 'wb') as audio_file:
    audio_file.write(
        text_to_speech.synthesize(
            'Lodges are also provided in the national park. They need to be booked in advance of 46 days for Indians and 90 days for foriegners.',
